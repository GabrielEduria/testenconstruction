        ...
        <Motion>
            <div className=" h-full p-4 md:pt-10 lg:px-30 z-10 text-center md:text-left">
                <h1 className="text-4xl md:text-7xl font-bold text-white drop-shadow-lg md:w-[700] pb-4">
                 ...
                 <p className="text-white text-base md:text-lg w-full md:w-[650px] pb-3 pl-1 px-4 md:leading-8 ">
                 ...
                 <div className="flex flex-wrap justify-center items-center md:justify-start gap-4 md:gap-8 pt-4 md:mt-5">
