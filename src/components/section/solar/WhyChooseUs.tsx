...
export default function WhyChooseUs () {
    return (
        <Motion>
          <div id="services" className="relative w-full min-h-screen py-20">
              ...
              {solarEnergy.map((item, index) => {
                    ...
                    return (
                        <div key={index}
                             ...
                             shadow-sm border-gray-100 hover:shadow-lg transition-all 
                             duration-300"
                         >
                           <div className="flex flex-col space-y-1.5 p-6">
                             ...
                             <p className="text-gray-600 p-6 pt-0">{item.description}</p>
